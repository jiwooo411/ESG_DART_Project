...
**관련 설계 문서**: 본 보고서의 Alpha 1~5 가운데 최종적으로 README 핵심 발견 3(Talk–Walk Gap, 44%)을 헤드라인 alpha로 선택한 근거와 대안 비교는 [`05b_talkwalk_gap_design_rationale.html`](05b_talkwalk_gap_design_rationale.html) 참조.
