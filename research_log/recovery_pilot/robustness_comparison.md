# Robustness Comparison — ESG DART (memberC)
...
- Independent ground truth (팀원 검증, 0523): Kiwi seed preservation 87% vs Okt 67% — Kiwi keeps more G-signals intact.
...
|---|---|---|
| MemberA universe target | 381 | 100.0 |
| success_memberC_native | 60 | 15.7 |
| partial_salvageable | 8 | 2.1 |
| awaiting_refetch_fy2024 | 127 | 33.3 |
| awaiting_refetch_oou | 186 | 48.8 |
| user_native_extension (out-of-MemberA) | 175 | 45.9 |
...
Items flagged as "🟡 partial" in COMPARISON_30단계_4인.html for memberC:
